 ...
 * @param oldStart
 */
export declare function updateRecurringRule(recurringRule: MbscRecurrenceRule | string, newStart: Date | string | {}, oldStart: Date | string | {}): MbscRecurrenceRule;
/**
 ...
 */
export declare function updateRecurringEvent(originalRecurringEvent: MbscCalendarEvent, oldEventOccurrence: MbscCalendarEvent | null, newEvent: MbscCalendarEvent | null, updatedEvent: MbscCalendarEvent | null, updateMode: 'current' | 'following' | 'all'): {
